...
export default function Modal({ open, onClose, title, children, maxWidth = 'max-w-lg' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center md:p-4">
      <div
        className="absolute inset-0 bg-black/50 backdrop-blur-sm animate-fade-in no-print"
        onClick={onClose}
      />
      <div
      ...
      >
        <div className="flex items-center justify-between px-5 sm:px-6 py-4 border-b border-brdr sticky top-0 bg-white rounded-t-3xl md:rounded-t-2xl z-10 no-print">
